    ...
    $("#form").submit(function() {
        ...
        function processData(data) {
            ...
            //single_way
                ...
                var from_info = "<ul class=\"Title\"><li class=\"Title5\">航空公司</li><li class=\"Title2\">航班 / 机型</li><li class=\"Title2\">起 / 降机场</li><li class=\"Title5\">起 / 降时间</li><li class=\"Title5\">最低价(不含税)</li><li class=\"Title5\">火车票价</li></ul>";

                $.each(data.from, function(res, detail) {
                    from_info += "<div class=\"Flight\">";
                    from_info += "<ul class=\"TicketsList\">";

                    from_info += "<li class=\"Code\">" + detail.company + "</li>";  
                    from_info += "<li class=\"Time\">" + detail.airlinecode + "<p>" + detail.mode + "</p></li>";
